...
export default function RecipeHomeScreen({navigation}) {
  ...
  return (
    <View className="flex-1 bg-white" style={{padding:10}}>
      ...
      >
        ...
        <View className="mx-4 space-y-2 mb-2">
          <Text style={{fontSize: hp(1.7)}} className="text-neutral-600">Hello, Friend!</Text>
          <View>
        ...
        <View className="mx-4 flex-row items-center rounded-full bg-black/5 p-[6px]">
          <TextInput
            ...
            onFocus={() => { navigation.navigate("RecipeSearch")}}
          />
